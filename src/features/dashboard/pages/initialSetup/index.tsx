...
const InitialSetupPage = () => {
    ...
    //TODO: niech ta strona dodaje wszystkie periody naraz.
    //      po zrobieniu jej zrób MR.
    //      kolejne MR to strona z danymi. logika:
    //     -----------------------------------------------------
    //      - użycie hooka żeby wywaliło bez periodów
    //      - sprawdzenie danych, jeśli puste to resp MultiStep
    //      - pierwsza stronka to import i export ZAWSZE
    return (
                ...
                >
                    ...
                    {newPeriodEndTime === 'NaN:NaN' && (
                        <MessageBox
                            ...
                            noClosing
                        >
                            {t('Provide time in HH:MM format')}
                        </MessageBox>
                    )}
                </LoadingBox>
            </FormWrapper>
